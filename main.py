...
def create_candidate_poles(buildings, radius=20, grid_spacing=1):
    ...
    lat_spacing = grid_spacing / 111111
    long_spacing = grid_spacing / (111111 * math.cos(math.radians(avg_lat)))
...
def main(file_path, poles_cost, mv_cost, lv_cost):
    ...
    #generate the candidate poles as before
    ...
    _ = visualize(buildings, final_poles, G, power_source)
'''
#code to output graph instead of canidate poles
def main(file_path, poles_cost, mv_cost, lv_cost):
...
if __name__ == "__main__":
    #set dataset here
    #file_path = "BuildingCoordinate(2).csv"
    file_path = "TestData2(1).csv"
    #file_path = "TestDataset(1).csv"
    pole_cost = 10
    mv_cost = 10
    lv_cost = 10

    main(file_path, pole_cost, mv_cost, lv_cost)
